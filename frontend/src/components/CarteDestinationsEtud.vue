<template>
    <a type="button" @click="oppenCard" data-bs-toggle="modal" data-bs-target="#exampleModal" class="carte col-12 w-25 col-xl-4 px-md-0 mx-2 bg-color d-flex flex-column pt-3 align-items-center border-0 justify-content-center">
