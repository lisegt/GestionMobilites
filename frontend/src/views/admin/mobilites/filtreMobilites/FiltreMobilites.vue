...
function recupererToutesPromo(){
    const fetchOptions = { method: "GET", headers: {"Authorization": localStorage.getItem('jwt')} }; //on utilise l'opération GET car on veut récupérer les promotions des mobilités
